      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 overflow-y-auto">
          <Routes>
            ...
            <Route path="/hiragana" element={<ProtectedRoute><Hiragana /></ProtectedRoute>} />
            <Route path="/katakana" element={<ProtectedRoute><Katakana /></ProtectedRoute>} />
            ...
            <Route path="/verbs" element={<ProtectedRoute><VerbTrainer /></ProtectedRoute>} />
            ...
            <Route path="/jlpt" element={<ProtectedRoute><JLPTPrep /></ProtectedRoute>} />
            <Route path="/exam/:examId" element={<ProtectedRoute><MockExam /></ProtectedRoute>} />
            <Route path="/exam-result/:resultId" element={<ProtectedRoute><ExamResultPage /></ProtectedRoute>} />
            <Route path="/mistakes" element={<ProtectedRoute><MistakesReview /></ProtectedRoute>} />
